...
void send_all_acceptable_packages(town *source, int source_office_index, town *target, int target_office_index)
{
    ...
    // {
    //     if (target->offices[target_office_index].min_weight < source->offices[source_office_index].packages->weight && target->offices[target_office_index].max_weight > source->offices[source_office_index].packages->weight)
    //     {
    //         target->offices->packages[target->offices->packages_count]= source->offices->packages[i];
